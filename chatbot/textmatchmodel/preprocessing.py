...
class preprocessing:
    ...
    def clean_docs(self,paras):
        ...
        for p in paras:
            ...
            cleaned_paras.append(cleaned_doc)
    ...
    def process(self):
        ...
        docs, labels, links = self.extract_data(json_data)
        cleaned_docs = self.clean_docs(docs)
        return docs, cleaned_docs, labels, links
    def trim_paras(self,paras):
        """"""
if __name__ == "__main__":
    pt = preprocessing("clcjsondata.txt")
    json_data = pt.load_docs()
    docs, cleaned_docs, labels,links = pt.process()
    print(len(docs))
