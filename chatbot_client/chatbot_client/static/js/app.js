...
function sendinput() {
    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            $('#json-context').html(
                '<pre>' + syntaxHighlight(JSON.stringify(json['json_data'], undefined, 2)) + '</pre>'
            );
            setTimeout(function() {
            ...
            setTimeout(function() {
                ...
                if(matched_link.length > 0 && matched_link.indexOf('https://childrenslegalcentre.wales/how-the-law-affects-me/') > -1){
